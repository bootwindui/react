...
`,e("p",{align:"center",children:t(n.p,{children:[e("a",{href:"#tentang",children:"Github Repository"})," • ",e("a",{href:"#fitur",children:"Storybook"}),` •
`,e("a",{href:"#download",children:"Getting Started"})," • ",e("a",{href:"#dukungan",children:"Contribution"})," ",`
• `,e("a",{href:"#lisensi",children:"License"})]})}),`
`,e("hr",{}),`
`,e("p",{}),`
`,e("h3",{className:"fluent",children:"Overview"}),`
`,t("div",{className:"fluent-text",children:[e(n.p,{children:"Welcome to Bootwind UI, where innovation meets simplicity in the realm of user interface development. Bootwind UI is a dynamic UI library designed to revolutionize your approach to building modern, responsive, and visually appealing interfaces. Whether you are a seasoned developer seeking efficiency or a newcomer looking for a powerful yet straightforward solution, Bootwind UI is your gateway to a world of possibilities."}),e(n.p,{children:"Key Features:"}),t(n.ul,{children:[`
`,t(n.li,{children:[e(n.strong,{children:"Tailored for Speed and Efficiency"}),": Bootwind UI leverages the power of Tailwind CSS, offering developers a utility-first approach to styling. With a comprehensive set of utility classes, you can achieve a polished and professional look for your UI with minimal effort."]}),`
`,t(n.li,{children:[e(n.strong,{children:"Responsive Design"}),": Craft responsive interfaces effortlessly. Bootwind UI ensures that your applications look and function flawlessly across a variety of devices and screen sizes, making it easy to create a consistent user experience."]}),`
