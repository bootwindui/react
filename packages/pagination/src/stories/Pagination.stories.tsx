...
const TemplateDefault = () => {
  ...
  return (
    <>
      <Title
        title="Pagination"
        description="The Pagination component in the Bootwind Design System allows you to navigate through a collection of items or pages in a structured and organized manner. With different types available, including Pagination Medium, Pagination Small, and Pagination Text, you can choose the style and functionality that best suits your design requirements."
      />
